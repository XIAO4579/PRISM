"""
MoE VL Discriminator Warmup Training Script

使用保存的 Qwen3-VL-MoE 模型进行 pairwise warmup 训练，
...
# --- 配置 ---
MOE_MODEL_PATH = "/training-data/sudongwang/model/Qwen3-VL-2B-MoE-4x"  # 保存的 VL MoE 模型
PROCESSOR_PATH = "/training-data/sudongwang/model/Qwen3-VL-2B-MoE-4x"
DATA_PATH = "/training-data/sudongwang/prm_workspace/dataset_process/data_pipeline/teacher_student_merged.jsonl"
OUTPUT_DIR = "/training-data/sudongwang/model/Qwen3-VL-2B-MoE-4x-warmup-distill"
...
class PairwiseVLDataset(Dataset):
    ...
    def __init__(self, data_path, processor, max_length=4096, image_base_path=None, max_pixels=560*560):
        ...
        # --- ✅ 修正部分开始 ---
        # 针对 Qwen2/3-VL，直接修改属性，不要去动 'size' 字典
...
def train():
    ...
    # 加载模型 - 使用自定义的 Qwen3VLMoeValueHead
    ...
    accelerator.print("Starting VL MoE Value Head Warmup Training")
