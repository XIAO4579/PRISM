...
def mmmu_process_results(doc, results):
    ...
    mmmu_exact_acc = {"id": doc["id"], "subdomain": extract_subset_name(doc["id"]), "question_type": doc["question_type"], "answer": doc["answer"], "parsed_pred": parsed_preds, "original_prediction": results[0], "formatted_question": construct_prompt(doc)}
