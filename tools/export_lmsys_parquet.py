...
def main():
    ...
    train_path = "/training-data/sudongwang/dataset/gad/lmsys_gpt5_chat_filtered_train.parquet"
    test_path = "/training-data/sudongwang/dataset/gad/lmsys_gpt5_chat_filtered_test.parquet"
